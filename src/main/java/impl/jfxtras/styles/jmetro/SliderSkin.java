...
public class SliderSkin extends javafx.scene.control.skin.SliderSkin {
	...
	private void thickMarksChanged(ObservableValue<?> observableValue) {
		/*
		 * When this method is called setShowTickMarks of super class has already been
		 * called on that method the children's list has been cleared so we need to
		 * re-add any Nodes that this Class adds to the Slider
		 */
	...
	private static final CssMetaData<Slider, Boolean> SHOW_VALUE_ON_INTERACTION_META_DATA = new CssMetaData<>(
